        ...
        {session && <>
          ...
          <div id="dropdown" className={`z-10 ${showdropdown?"":"hidden"} absolute left-25 bg-gray-700 rounded-sm shadow-lg w-44`}>
            <ul className="p-2 text-sm text-body font-medium" aria-labelledby="dropdownDefaultButton">
              ...
              <li>
                <Link href="#" className="inline-flex items-center w-full p-2 hover:bg-gray-600 rounded">Settings</Link>
              </li>
              <li>
                <Link href="#" className="inline-flex items-center w-full p-2 hover:bg-gray-600 rounded">Earnings</Link>
              </li>
              <li>
